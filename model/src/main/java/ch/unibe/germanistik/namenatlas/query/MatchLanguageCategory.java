...
/** Filters {@link Tokens} by the {@linkplain Type#getLanguageCategories() language category}
 *  of the associated {@link Type}.
 */
@Schema
@Value.Immutable
@JsonDeserialize(as = ImmutableMatchLanguageCategory.class)
public abstract class MatchLanguageCategory extends FilterPredicate {
    public abstract LanguageCategory getLanguageCategory();
    ...
    public Predicate querydslPredicate(QTokensEntity tokens) {
        return Expressions.booleanTemplate(
            ...
            tokens.type.languageCategories,
            getLanguageCategory().name()
        );
    }
