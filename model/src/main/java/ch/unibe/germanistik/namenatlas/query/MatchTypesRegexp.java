...
/** Filters {@link Tokens} by a regular expression match on the associated {@link Type}. */
@Schema
@Value.Immutable
@JsonDeserialize(as = ImmutableMatchTypesRegexp.class)
public abstract class MatchTypesRegexp extends FilterPredicate {
    ...
    public Predicate querydslPredicate(QTokensEntity tokens) {
        ...
        return Expressions.booleanTemplate(
            ...
            tokens.type.name,
            // Make sure that the regexp always matches against the complete
            // value
            "^(" + getRegexp() + ")$"
        );
    }
